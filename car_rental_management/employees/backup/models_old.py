...
class Employee(models.Model):
    ...
    employeecity = models.CharField(db_column='employeeCity', max_length=50, blank=True, null=True)  # Field name made lowercase.
    employeestate = models.CharField(db_column='employeeState', max_length=3, blank=True, null=True)  # Field name made lowercase.
...
class Store(models.Model):
    ...
    storecity = models.CharField(db_column='storeCity', max_length=50, blank=True, null=True)  # Field name made lowercase.
    storestate = models.CharField(db_column='storeState', max_length=3, blank=True, null=True)  # Field name made lowercase.
